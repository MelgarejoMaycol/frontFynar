...
const FinancialHealthPage = lazy(() =>
  import('@/features/financial-health').then((module) => ({
    default: module.FinancialHealthPage,
  })),
)
...
const InvestmentsPage = lazy(() =>
  import('@/features/investments').then((module) => ({
      ...
      <Route element={<ProtectedRoute />}>
        <Route path="/app" element={<AppLayout />}>
          ...
          <Route element={<WorkspaceGate />}>
            ...
            <Route path="investments" element={pending(<InvestmentsPage />)} />
            <Route
            ...
            <Route
              ...
              element={pending(<InvestmentPlanDetailPage />)}
            />
            ...
            <Route
              path="notifications"
              element={pending(<NotificationsPage />)}
            />
