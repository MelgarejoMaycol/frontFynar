...
const openEditor = () => {
  fireEvent.click(screen.getByRole('button', { name: 'Editar imagen' }))
}

const getFileInput = () =>
  screen.getByLabelText('Seleccionar') as HTMLInputElement
...
describe('AvatarUploader', () => {
  ...
  it('acepta arrastrar y soltar una imagen válida', () => {
    ...
    const zone = screen.getByText('Arrastra una imagen').parentElement!
